...
class BotMessage:
    ...
    BUY_ACCESS_MESSAGE = "Здесь будет информация о том, как купить подписку.\n" \
                         ...
                         "\nПосле оплаты напишите нам в поддержку или нажмите кнопку 'Оплачено'\n\n" \
                         "Вам будет необходимо указать юзера, для которого вы произвели оплату\n" \
                         "Мы проверим оплаченную вами сумму и в зависимости от " \
                         "ее количества выдадим вам нужный доступ\n"
    CHECK_USER_FOR_CODE_MESSAGE = "Делаем проверку Вашего юзера для выдачи пробного доступа к сервису cryptospread.net"
    ...
    NEXT_SECTION_GREETING = "Выбери дальнейшее действие"
    GO_TO_CRYPTOSPREAD = 'Перейти на Cryptospread'
